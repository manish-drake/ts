...
int DataBuilder::build()
{
    ...
    TestParam tpPosLat("latitude", sumPos.id(), "Latitude", "__._____°", "N", 0, 0,0, 2, 0);
    tpModel.addTestParam(tpPosLat);

    TestParam tpPosLong("longitude", sumPos.id(), "Longitude", "____._____°", "W", 1, 0, 0, 2, 0);
    ...
    TestParam tpOFldsSurSts("surveillance-Status", sumOFlds.id(), "Surveillance Status", "", "", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpOFldsSurSts);

    TestParam tpOFldsNicSb("nic-SB", sumOFlds.id(), "NIC-SB", "", "", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpOFldsNicSb);

    TestParam tpOFldsCprFrmt("cpr-Format", sumOFlds.id(), "CPR Format", "", "", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpOFldsCprFrmt);

    TestParam tpOFldsUtcSync("utc-Sync", sumOFlds.id(), "UTC Sync", "", "", 3, 0, 0, 2, 0);
    ...
    TestParam tpAVInfoAID("aircraft-ID", sumAVInfo2.id(), "Aircraft ID", "", "", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpAVInfoAID);

    TestParam tpAVInfoEC("emitter-Cat", sumAVInfo2.id(), "Emitter Cat", "__ (______) ", "", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpAVInfoEC);
    ...
    TestParam tpFltDataHdg("heading", sumFltData.id(), "Heading", "", "", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpFltDataHdg);

    TestParam tpFltDataAirspd("airspeed", sumFltData.id(), "Airspeed", "", "", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpFltDataAirspd);

    TestParam tpFltDataVerRt("vertical-Rate", sumFltData.id(), "Vertical Rate", "", "fpm", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpFltDataVerRt);

    TestParam tpFltDataGBAlt("Geom/Baro Alt", sumFltData.id(), "Geom/Baro Alt", "", "ft", 3, 0, 0, 2, 0);
    ...
    TestParam tpOFlds1Nacv("nacv", sumOFlds1.id(), "NACv", "__ (< __m/s)", "", 1, 0, 0);
    ...
    TestParam tpOFlds1hdgSts("hdg-Sts", sumOFlds1.id(), "Hdg Sts", "", "", 2, 0, 0, 2, 0);
    ...
    TestParam tpIntDataNacp("nacp", sumIntData.id(), "NACp", "__ (< __nm)", "", 0, 0, 0);
    ...
    TestParam tpIntDataGva("gva", sumIntData.id(), "GVA", "__ (< ___m)", "", 1, 1, 0);
    tpModel.addTestParam(tpIntDataGva);

    TestParam tpIntDataSil("sil", sumIntData.id(), "SIL", "__ (< __ -__ )", "", 2, 0, 0);
    ...
    TestParam tpCapStsTra("tcas-Ra", sumCapSts.id(), "TCAS RA",  "_ (_)", "", 2, 1, 0);
    ...
    TestParam tpCapStsidt("ident", sumCapSts.id(), "IDENT", "_ (_)", "", 4, 1, 0);
    ...
    TestParam tpOFlds2Hrd("hrz-Ref-Dir", sumOFlds2.id(), "Hrz Ref Dir", "", "", 2, 0, 0, 2, 0);
    ...
    TestParam tpTsSAlt("sel.-Altitude", sumTse.id(), "Sel. Altitude", "", "", 0, 0, 0);
    tpModel.addTestParam(tpTsSAlt);

    TestParam tpTseNs("nic-supA", sumTse.id(), "NIC-supA", "", "", 0, 1, 0);
    tpModel.addTestParam(tpTseNs);

    TestParam tpTseBs("baro-Setting", sumTse.id(), "Baro Setting", "", "mb", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpTseBs);

    TestParam tpTseSh("sel.-Heading", sumTse.id(), "Sel. Heading", "", "deg", 2, 0, 0);
    ...
    TestParam tpApMMbs("mode-Bits-Status", sumApM1.id(), "Mode bits status", "", "", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpApMMbs);

    TestParam tpApMAp("autopilot-(AP)", sumApM1.id(), "Autopilot (AP)", "", "", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpApMAp);

    TestParam tpApMVnav("vnav", sumApM1.id(), "VNAV", "", "", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpApMVnav);

    TestParam tpApMAltH("alt.-Hold-(ALT)", sumApM1.id(), "Alt. Hold (ALT)", "", "", 3, 0, 0, 2, 0);
    tpModel.addTestParam(tpApMAltH);

    TestParam tpApMApp("approach-(APP)", sumApM1.id(), "Approach (APP)", "", "", 4, 0, 0, 2, 0);
    tpModel.addTestParam(tpApMApp);

    TestParam tpApMlnav("lnav", sumApM1.id(), "LNAV", "", "", 5, 0, 0, 2, 0);
    ...
    TestParam tpRfSTEsr("extended-Squitter-Rate", sumRfST.id(), "Extended Squitter Rate", "", "sec", 0, 0, 0, 2, 1);
    tpModel.addTestParam(tpRfSTEsr);

    Summary sumRfData("1090 MHz RF Data:", adsbOut1090.id(), 6, 2, 2);
    sumModel.addSummary(sumRfData);

    TestParam tpRfDataMf("measured-frequency", sumRfData.id(), "Measured frequency", "", "MHz", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpRfDataMf);

    TestParam tpRfDataMp("measure-power", sumRfData.id(), "Measure power", "", "dBm", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpRfDataMp);

    TestParam tpRfDataEc("error-conditions", sumRfData.id(), "Error conditions", "", "", 2, 0, 0, 2, 0);
    ...
    TestParam tpAirVeh7FId("qualifier", sumAirVeh7.id(), "Qualifier", "", "", 1, 0, 0);
    ...
    TestParam tpAirVeh7Bds("payloads-Rcvd", sumAirVeh7.id(), "Payloads Rcvd", "", "", 2, 0, 0, 2, 0);
    ...
    TestParam tpOtherFldnacp("nacp", sumOtherFld.id(), "NACp", "__ (< __nm)", "", 0, 0, 0);
    ...
    TestParam tpOtherFldsil("sil", sumOtherFld.id(), "SIL", "__ (< __ -__ )", "", 1, 1, 0);
    ...
    TestParam tpOtherFldgva("gva", sumOtherFld.id(), "GVA", "__ (< ___m)", "", 2, 1, 0);
    ...
    TestParam tpOtherFldnsup("nicsup", sumOtherFld.id(), "NICsup", "", "", 5, 0, 0, 2, 0);
    ...
    TestParam tpAirVeh8FId("qualifier", sumAirVeh8.id(), "Qualifier", "", "", 1, 0, 0);
    ...
    TestParam tpAirVeh8Bds("payloads-Rcvd", sumAirVeh8.id(), "Payloads Rcvd", "", "", 2, 0, 0, 2, 0);
    ...
    TestParam tpPosVel1lat("latitude", sumPosVel1.id(), "Latitude", "__._____°", "N", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpPosVel1lat);

    TestParam tpPosVel1long("longitude", sumPosVel1.id(), "Longitude", "____._____°", "W", 2, 0, 0, 2, 0);
    ...
    TestParam tpPosVel1hv("horizontal-Velocity", sumPosVel1.id(), "Horizontal Velocity", "", "", 4, 0, 0, 2, 0);
    ...
    TestParam tpOtherFld1Nic("nic", sumOtherFld1.id(), "NIC", "__ (RC< __nmi)", "", 0, 0, 0);
    ...
    TestParam tpOtherFld1Uf("uplink-Feedback", sumOtherFld1.id(), "Uplink Feedback", "", "", 1, 0, 0, 2, 0);
    ...
    TestParam tpAuxSv1SecAlt("secondary-Altitude", sumAuxSv1.id(), "Secondary Altitude", "", "ft", 0, 0, 0, 2, 0);
    ...
    TestParam tpAirVeh9FId("qualifier", sumAirVeh9.id(), "Qualifier", "", "", 1, 0, 0);
    ...
    TestParam tpAirVeh9Bds("payloads-Rcvd", sumAirVeh9.id(), "Payloads Rcvd", "", "", 2, 0, 0, 2, 0);
    ...
    TestParam tpPosVel2lat("latitude", sumPosVel2.id(), "Latitude", "__._____°", "N", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpPosVel2lat);

    TestParam tpPosVel2long("longitude", sumPosVel2.id(), "Longitude", "____._____°", "W", 2, 0, 0, 2, 0);
    ...
    TestParam tpPosVel2gsp("groundspeed", sumPosVel2.id(), "Groundspeed", "", "kts", 4, 0, 0, 2, 0);
    ...
    TestParam tpPosVel2avlw("a/v-L/W", sumPosVel2.id(), "A/V L/W", "", "", 6, 0, 0, 2, 0);
    tpModel.addTestParam(tpPosVel2avlw);

    TestParam tpPosVel2gao("gps-Ant-Offset", sumPosVel2.id(), "GPS Ant Offset", "", "", 7, 0, 0, 2, 0);
    tpModel.addTestParam(tpPosVel2gao);

    Summary sumOtherFld2("Other Fields:", uatOut.id(), 2, 3, 2);
    sumModel.addSummary(sumOtherFld2);

    TestParam tpOtherFld2Nic("nic", sumOtherFld2.id(), "NIC", "__ (RC< __nmi)", "", 0, 0, 0);
    ...
    TestParam tpOtherFld2Uf("uplink-Feedback", sumOtherFld2.id(), "Uplink Feedback", "", "", 1, 0, 0, 2, 0);
    ...
    TestParam tpAuxSv2secAlt("secondary-Altitude", sumAuxSv2.id(), "Secondary Altitude", "", "ft", 0, 0, 0);
    ...
    TestParam tpAirVeh10FId("qualifier", sumAirVe10.id(), "Qualifier", "", "", 1, 0, 0);
    ...
    TestParam tpAirVeh10Bds("payloads-Rcvd", sumAirVe10.id(), "Payloads Rcvd", "", "", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpAirVeh10Bds);

    Summary sumTS("Target state Element (TS)", uatOut.id(), 3, 1, 1);
    sumModel.addSummary(sumTS);

    TestParam tpTSSAlt("sel.-Altitude", sumTS.id(), "Sel. Altitude", "", "ft", 0, 0, 0);
    tpModel.addTestParam(tpTSSAlt);

    TestParam tpTSTyp("type", sumTS.id(), "Type", "", "", 0, 1, 0);
    tpModel.addTestParam(tpTSTyp);

    TestParam tpTSBStt("baro-Setting", sumTS.id(), "Baro Setting", "", "mb", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpTSBStt);

    TestParam tpTSSelH("sel.-Heading", sumTS.id(), "Sel. Heading", "", "deg", 2, 0, 0);
    ...
    TestParam tpApM2Mbs("mode-bits-status", sumApM2.id(), "Mode bits status", "", "", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpApM2Mbs);

    TestParam tpApM2Ap("autoPilot-(AP)", sumApM2.id(), "AutoPilot (AP)", "", "", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpApM2Ap);

    TestParam tpApM2Vnav("vnav", sumApM2.id(), "VNAV", "", "", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpApM2Vnav);

    TestParam tpApM2Alt("alt.-Hold-(ALT)", sumApM2.id(), "Alt. Hold (ALT)", "", "", 3, 0, 0, 2, 0);
    tpModel.addTestParam(tpApM2Alt);

    TestParam tpApM2App("approach-(APP)", sumApM2.id(), "Approach (APP)", "", "", 4, 0, 0, 2, 0);
    tpModel.addTestParam(tpApM2App);

    TestParam tpApM2lnav("lnav", sumApM2.id(), "LNAV", "", "", 5, 0, 0, 2, 0);
    ...
    TestParam tpAirVeh11FId("qualifier", sumAirVe11.id(), "Qualifier", "", "", 1, 0, 0);
    ...
    TestParam tpAirVeh11Bds("payloads-Rcvd", sumAirVe11.id(), "Payloads Rcvd", "", "", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpAirVeh11Bds);

    Summary sumTce("Trajectory Change Element", uatOut.id(), 4, 1, 1);
    sumModel.addSummary(sumTce);

    TestParam tpTceTcFld("tc-Field", sumTce.id(), "TC Field", "", "", 0, 0, 0, 2, 0);
    ...
    TestParam tpAirVeh12FId("qualifier", sumAirVe12.id(), "Qualifier", "", "", 1, 0, 0);
    ...
    TestParam tpAirVeh12Bds("payloads-Rcvd", sumAirVe12.id(), "BDS Rcvd (DF17)", "_,_ _,_ _,_ _,_ _,_", "", 2, 0, 0, 2, 0);
    ...
    TestParam tpRflMFq("frequency", sumRflM.id(), "Frequency", "", "MHz", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMFq);

    TestParam tpRflMPwr("power", sumRflM.id(), "Power", "", "dBm (Medium)", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMPwr);

    TestParam tpRflMErrC("error-conditions", sumRflM.id(), "Error conditions", "", "", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMErrC);

    TestParam tpRflMPwrD("power-Drop", sumRflM.id(), "Power Drop", "", "dB", 3, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMPwrD);

    TestParam tpRflMD("deviation", sumRflM.id(), "Deviation", "", "%", 4, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMD);

    TestParam tpRflMPD("peak-Deviation", sumRflM.id(), "Peak Deviation", "", "%", 5, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMPD);

    TestParam tpRflMVEO("vert-Eye-Opening", sumRflM.id(), "Vert Eye Opening", "", "%", 6, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMVEO);

    TestParam tpRflMHEO("horz-Eye-Opening", sumRflM.id(), "Horz Eye Opening", "", "%", 7, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMHEO);

    TestParam tpRflMMTErr("message-Time-Error", sumRflM.id(), "Message Time Error", "", "uS", 8, 0, 0, 2, 0);
    tpModel.addTestParam(tpRflMMTErr);

    Summary sumUatMsgSum("UAT Message Summary:", uatOut.id(), 5, 2, 2);
    sumModel.addSummary(sumUatMsgSum);

    TestParam tpUatMsgSumMsgRcvd("message-Received", sumUatMsgSum.id(), "Message Received", "", "", 0, 0, 0, 2, 0);
    tpModel.addTestParam(tpUatMsgSumMsgRcvd);

    TestParam tpUatMsgSumMIMsg("missing/Incorrect-Messages", sumUatMsgSum.id(), "Missing/Incorrect Messages", "", "", 1, 0, 0, 2, 0);
    tpModel.addTestParam(tpUatMsgSumMIMsg);

    TestParam tpUatMsgSumMsgSR("message-Success-Rate", sumUatMsgSum.id(), "Message Success Rate", "", "%", 2, 0, 0, 2, 0);
    tpModel.addTestParam(tpUatMsgSumMsgSR);

    TestParam tpUatMsgSumCMsgBE("current-Message-Bit-Errors", sumUatMsgSum.id(), "Current Message Bit Errors", "", "", 3, 0, 0, 2, 0);
    tpModel.addTestParam(tpUatMsgSumCMsgBE);

    TestParam tpUatMsgSumMSgSeq("message-Sequence", sumUatMsgSum.id(), "Message Sequence", "", "", 4, 0, 0, 2, 0);
    tpModel.addTestParam(tpUatMsgSumMSgSeq);

    TestParam tpUatMsgSumMsgPld("message-Payloads", sumUatMsgSum.id(), "Message Payloads", "", "", 5, 0, 0, 2, 0);
